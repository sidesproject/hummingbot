...
class BinanceExchange(ExchangePyBase):
    ...
    def name(self) -> str:
        if self._domain == "com":
            return "binance"
        elif self._domain == CONSTANTS.CROSS_MARGIN_DOMAIN:
            return CONSTANTS.CROSS_MARGIN_DOMAIN
        else:
    ...
    async def _update_balances(self):
        ...
        is_cross_margin = self._domain == CONSTANTS.CROSS_MARGIN_DOMAIN

        # Cross margin uses /papi/v1/balance (returns plain array, no wrapper key)
